      ...
      child: ScaleTransition(
        ...
        child: AnimatedScale(
          ...
          child: Container(
            ...
            child: CircleAvatar(
              radius: radius,
              backgroundImage: const AssetImage('assets/images/roshan.jpeg'),
            ),
          ),
        ),
      ),
      ...
      child: FadeTransition(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "I’m Roshan, a passionate Flutter developer with 2 years of experience building beautiful mobile and web apps using Flutter, Dart, and Firebase.",
              style: GoogleFonts.poppins(
