                        ...
                        MouseRegion(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: ElevatedButton(
                              onPressed: () => launchUrl(
                                Uri.parse(
                                    'https://drive.google.com/file/d/1fDxS-7ml2zS48PrGt0512wU4mVTgrUtF/view?usp=drive_link,'),
                              ),
          ...
          SlideTransition(
            ...
            child: FadeTransition(
              ...
              child: Column(
                children: [
                  ElevatedButton(
                    onPressed: () => launchUrl(Uri.parse('https://example.com/resume.pdf')),
                    style: ElevatedButton.styleFrom(
                      padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 16),
    ...
    return Row(
      ...
      children: [
        _buildSocialIcon(
            ...
            'https://linkedin.com/in/roshan-chachre'),
        _buildSocialIcon(
          image: "assets/svg/git_icon.svg",
          Icons.code,
          Colors.black87,
          'https://github.com/RoshanRyuu',
        ),
        _buildSocialIcon(
          Icons.mail_outline,
          Colors.red.shade700,
          'mailto:roshanchachre21@gmail.com',
        ),
      ],
    );
  }
